...
Revision ID: 9ba56420afb2
Revises: 
Create Date: 2025-05-24 01:04:50.312002
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('MULTIPLAYER', 'SINGLE', 'ANALYSIS', name='gametype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('REQUESTED', 'ACCEPTED', 'DECLINED', name='friendshipstatus'), nullable=False),
    sa.Column('left_user_id', sa.UUID(), nullable=False),
    sa.Column('right_user_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['left_user_id'], ['users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['right_user_id'], ['users.id'], ondelete='CASCADE'),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('trump_suit', sa.Enum('H', 'D', 'C', 'S', name='suit'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['game_id'], ['games.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['opening_player_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_rounds_id'), 'rounds', ['id'], unique=False)
    op.create_table('dealings',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'round_id', name='_user_round_uc')
    )
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('suit', sa.Enum('H', 'D', 'C', 'S', name='suit'), nullable=False),
    sa.Column('value', sa.Integer(), nullable=False),
    sa.Column('dealing_id', sa.UUID(), nullable=False),
    sa.Column('entry_id', sa.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['dealing_id'], ['dealings.id'], ondelete='CASCADE'),
